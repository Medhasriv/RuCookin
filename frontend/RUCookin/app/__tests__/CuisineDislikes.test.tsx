...
import CuisineDislikes from '../CuisineDislikes';
...
describe('CuisineDislikes Component', () => {
  it('renders correctly', () => {
    render(<CuisineDislikes />);
    
    expect(screen.getByText("Select cuisines you dislike")).toBeTruthy();
  });
  ...
  it('calls handleContinue when the continue button is pressed and navigates', async () => {
    ...
    await waitFor(() => {
      expect(mockPush).toHaveBeenCalledWith('/Diets');
    });
